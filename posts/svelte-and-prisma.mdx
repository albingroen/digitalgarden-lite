...
date: "2021-12-07"
author: "Albin Groen"
excerpt: "How you can build a serverless web application with Svelte Kit & Prisma"
...
Kit. You can look at Svelte Kit like kind of the Svelte version of React's
Next.js.

The backend for this application will be provided by Svelte Kit's serverless
...
To set up our project, we need to start by creating a new Svelte Kit
...
Now that we've got a basic Svelte Kit endpoint set up for creating a new user,
...
<form on:submit|preventDefault|stopPropagataion={handleSubmit}>
...
Hosting a Svelte Kit app is quite easy to do on most platforms. One thing you
